 ...
 */
public class EclipseKeymap implements BundledKeymapProvider {
    @NotNull
    @Override
    public List<String> getKeymapFileNames() {
        return Collections.singletonList("Eclipse.xml");
    }
    ...
    public <R> R load(@NotNull String key, @NotNull Function<? super InputStream, ? extends R> consumer) throws IOException {
        ...
        try (InputStream stream = EclipseKeymap.class.getResourceAsStream("/keymaps/" + os + "/" + key)) {
